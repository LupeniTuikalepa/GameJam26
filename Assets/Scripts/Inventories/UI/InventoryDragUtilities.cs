...
{
    public static class InventoryDragUtilities
    {
        public static Vector3 GetPos(Vector2 screenPos, Canvas canvas) =>
            GetPos(screenPos, canvas, canvas.worldCamera);

        public static Vector3 GetPos(Vector2 screenPos, Canvas canvas, Camera camera)
        {
